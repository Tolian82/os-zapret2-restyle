...
MODEL_B_ADAPTER="${STRATEGY_LAB_MODEL_B_SYSTEM_ADAPTER:-${SCRIPT_DIR}/strategy_lab_model_b_parallel_adapter.sh}"
...
export STRATEGY_LAB_MODEL_C_LIFECYCLE_MEASUREMENT_DIR STRATEGY_LAB_MODEL_B_SYSTEM_ADAPTER
