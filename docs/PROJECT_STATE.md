...
- The next bounded runner is `tgvoice_fakefrag8_reverse24_postnat_v1.py`, revision `postnat-fakefrag8-reverse24-v1`, SHA-256 `c4ee47779d778f50b04e48ffe744f5d098d3fb32863133b7d3a8d7ed6c633d24`. It adds one 40-byte zero fake with intentionally bad UDP checksum and random IPv4 ID, fragmented ordered at UDP position 8, before the already-qualified real reverse24 serialization. Python syntax and `--help` passed; no live fake-plus-fragment result exists yet.
