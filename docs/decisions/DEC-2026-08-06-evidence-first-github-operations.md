...
The audit also found conflicting active wording:
...
Before any GitHub mutation, inspect the exact current:
...
- connector/API/ordinary Git/`gh` capabilities and permissions.
...
This decision has priority for GitHub mutation, failure handling, candidate prerelease
publication, and release-preparation title mechanics.
