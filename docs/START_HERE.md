...
Scope note: the owner states this is an internal laboratory test on owner-controlled infrastructure; sanctions or sanctions-related restriction circumvention is not an objective of this work.
...
- The next prepared runner is `tgvoice_fakefrag8_reverse24_postnat_v1.py`, revision `postnat-fakefrag8-reverse24-v1`, SHA-256 `db8d8a9e1e67c2df91a77462d244be37988bbda8cd674bca7c0b77d16d8cc03d`. It adds one 40-byte zero fake with bad UDP checksum and random IPv4 ID, fragmented ordered at UDP position 8, before the already-qualified real reverse24 serialization.
