...
require "${STATE}" 'current published testing package/tag: `os-zapret2-restyle-0.4.1_13.pkg` / `v0.4.1_13`'
require "${STATE}" 'testing-package SHA-256: `7a2f864aa14ba2170ca378954ab5421092b76aca79b7b1765b976de2f024797b`'
...
require "${START_HERE}" 'current testing package/tag: `os-zapret2-restyle-0.4.1_13.pkg` / `v0.4.1_13`'
