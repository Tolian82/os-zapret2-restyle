...
grep -Fq -- "--tls-max 1.2" "${MODULE_DIR}/extended_request.sh"
grep -Fq -- "--proto '=http'" "${MODULE_DIR}/extended_request.sh"
echo 'PASS: Strategy Lab extended TLS 1.2 and HTTP branches use isolated protocol-specific contracts'
